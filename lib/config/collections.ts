...
export const MASTER_COLLECTIONS: CollectionConfig[] = [
  ...
  },
  {
    ...
    shortLabel: "Hair Accessories",
    navEmoji: "🎀",
    shelfSubtitle:
      "Botanical floral silk scrunchies and heritage Korean hair ornaments",
    aliases: ["hair-accessories", "hair-wear", "hair", "scrunchies", "hairpins"],
    keywords: ["hair", "scrunchie", "hairpin", "binyeo", "daenggi"],
    productTypeConditions: ["Hair Accessories", "Hair Wear", "Hair", "Scrunchie"],
    priority: 3,
    superCategory: "wear",
  },
  {
    handle: "modern-hanbok",
    title: "Modern Hanbok & Apparel",
    ...
    keywords: [
      ...
      "tshirt", "t-shirt", "tee", "shirt", "blouse", "pants", "slacks", "trousers", "knit", "cardigan", "clothing", "apparel"
    ],
    productTypeConditions: [
      "Modern Hanbok & Apparel", "Modern Hanbok", "Modern Fashion & Hanbok", "Hanbok", "Apparel", "Clothing", "Fashion",
      "T-Shirt", "Tshirt", "Shirt", "Blouse", "Pants", "Slacks", "Trousers", "Knit", "Knitwear", "Sweater", "Cardigan", "Jacket", "Skirt", "Dress"
    ],
    priority: 4,
    superCategory: "wear",
  },
  ...
  },
  {
    ...
    keywords: ["ceramic", "porcelain", "moon jar", "celadon", "cup", "teacup", "plate", "bowl", "tea", "teaware"],
  ...
  },
  {
    ...
    title: "Home Textiles",
    shortLabel: "Home Textiles",
    navEmoji: "🍵",
    shelfSubtitle:
      "Iridescent Sun & Moon Joseon tea coaster sets and heritage living crafts",
    aliases: ["home-textiles", "fabric-living", "home-living", "home-goods", "home", "fabric", "living"],
    keywords: ["textiles", "coaster", "tea coaster", "tea mat", "fabric", "mat", "bojagi", "knot", "tableware"],
    productTypeConditions: ["Home Textiles", "Fabric Living", "Home & Living", "Living"],
    priority: 7,
    superCategory: "living",
  },
  {
  ...
  },
  {
    ...
    title: "Woodcraft & Mother-of-Pearl",
